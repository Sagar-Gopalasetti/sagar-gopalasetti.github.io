...
export const ABOUT_TEXT = `I am a full-stack software engineer with 5+ years of experience building scalable web applications, API-driven platforms, and user-focused digital products using React, TypeScript, JavaScript, Node.js, Python, REST APIs, SQL, and cloud technologies. I recently completed my Master’s in Computer Science from the University at Buffalo and currently work as an Application Developer at the University of Oklahoma.

My experience spans AI-powered search and chatbot platforms, analytics dashboards, e-commerce workflows, mobile applications, and SaaS products. I enjoy working across the stack, from building responsive frontend interfaces to developing secure backend services and scalable API integrations. I am passionate about clean code, performance, product usability, and solving real-world problems through technology.
`
...
`,
    technologies: ["Node.js", "Express.js", "SASS", "React.js", "Jenkins"],
  },
];
